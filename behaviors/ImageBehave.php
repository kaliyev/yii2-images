...
namespace kaliyev\yii2images\behaviors;
...
class ImageBehave extends Behavior
{
    ...
    public function attachImage($absolutePath, $isMain = false, $name = '')
    {
        ...
        if(
            is_object($img) && get_class($img)=='kaliyev\yii2images\models\PlaceHolder'
            or
            $img == null
            or
            $isMain
     ...
     */
    public function getImages($placeholder = false)
    {
        ...
        if(!$imageRecords && $placeholder && $this->getModule()->placeHolderPath){
